...
public class PhoenixPathway extends Plugin 
{
	...
	{		
		...
		{	
			...
			{				
				...
				*/
				...
				Points startP = getStartingPoints();
				
				if(startP != null)
					putMarkers(startP, false);
				// ===================================================== //	
		...
		public Points getStartingPoints()
		{
			Points startPoint = null;
			...
			{	
				...
				if(!roomName.isEmpty() && roomName.equalsIgnoreCase("foyer"))
				{
					...
					if(roomRect.length > 1)
						startPoint = new Points(((roomRect[0][0] + roomRect[1][0]) / 2), ((roomRect[0][1] + roomRect[1][1]) / 2));
				}
			}
			...
			if(startPoint == null)
			{
				...
				{
					if(hpf.getName().equalsIgnoreCase("entrydoor"))
					{
						startPoint = new Points(hpf.getX(), hpf.getY());
					}
				}
			}
